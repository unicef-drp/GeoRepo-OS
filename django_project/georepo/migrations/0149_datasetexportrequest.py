# Generated by Django 4.0.7 on 2025-10-13 07:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('georepo', '0148_backgroundtask_resources'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('format', models.CharField(choices=[('GEOJSON', 'GEOJSON'), ('SHAPEFILE', 'SHAPEFILE'), ('KML', 'KML'), ('TOPOJSON', 'TOPOJSON'), ('GEOPACKAGE', 'GEOPACKAGE')], max_length=255)),
                ...
                ('source', models.CharField(blank=True, help_text='API or dashboard', max_length=255, null=True)),
                ('file_output_size', models.IntegerField(blank=True, default=0, null=True)),
