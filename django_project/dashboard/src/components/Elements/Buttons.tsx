 ...
 * @param onClick
 */
export function ThemeButton({ icon, title, variant, disabled = false, onClick = null, additionalClass = null, sx = null, disabledTitle = null } : ThemeButtonInterface) {
  return (
    <Button
      disabled={disabled}
      ...
      onClick={onClick}
      sx={sx}
      aria-label={disabled && disabledTitle ? disabledTitle : title}
